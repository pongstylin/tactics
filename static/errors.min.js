...
/*!***********************!*\
  !*** ./src/errors.js ***!
  \***********************/(__unused_webpack___webpack_module__,__webpack_exports__,__webpack_require__)=>{"use strict";eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var core_js_modules_es_string_replace_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.string.replace.js */ \"./node_modules/core-js/modules/es.string.replace.js\");\n/* harmony import */ var core_js_modules_es_string_split_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/es.string.split.js */ \"./node_modules/core-js/modules/es.string.split.js\");\n/* harmony import */ var config_client_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! config/client.js */ \"./config/client.js\");\n\n\n\n\nif (window.sessionStorage) {\n  var data = window.sessionStorage.getItem('reportData');\n  if (data) sendReport(data);\n}\n\nvar errorListener = function errorListener(event) {\n  try {\n    var now = new Date();\n    report({\n      type: event.type,\n      message: event.message,\n      filename: event.filename,\n      lineno: event.lineno === undefined ? null : event.lineno,\n      colno: event.colno === undefined ? null : event.colno,\n      error: event.error ? getErrorData(event.error) : null\n    }, now);\n  } catch (e) {\n    var error = 'Log error failed: ' + e;\n    error = error.replace(/\"/g, '\\\\\"');\n    sendReport('{\"error\":\"' + error + '\"}');\n  }\n};\n\nvar unhandledrejectionListener = function unhandledrejectionListener(event) {\n  try {\n    var now = new Date();\n    var reportData = {\n      type: event.type\n    };\n    var promise = event.promise;\n    var error = event.reason;\n    if (promise.ignoreConnectionReset && error === 'Connection reset') return event.preventDefault();\n    if (error instanceof Error) reportData.error = getErrorData(error);else if (error !== undefined) reportData.error = error + '';\n    reportData.promise = promise.tags;\n    report(reportData, now);\n  } catch (e) {\n    var error = 'Log reject failed: ' + e;\n    error = error.replace(/\"/g, '\\\\\"');\n    sendReport('{\"error\":\"' + error + '\"}');\n  }\n};\n/*\n * \"Cannot set property onunhandledrejection of [object Object] which has only a getter\"\n *\n * I don't know why I got this strange error since the property should always be\n * settable even if it doesn't exist.  So, let's favor 'addEventListener' and\n * fallback to assignment if necessary.\n */\n\n\ntry {\n  window.addEventListener('error', errorListener);\n  window.addEventListener('unhandledrejection', unhandledrejectionListener);\n} catch (e) {\n  window.onerror = function (message, source, lineno, colno, error) {\n    errorListener({\n      type: 'error',\n      message: message,\n      filename: source,\n      lineno: lineno,\n      colno: colno,\n      error: error\n    });\n  };\n\n  window.onunhandledrejection = unhandledrejectionListener;\n}\n\nfunction getErrorData(error) {\n  let stack = error.stack;\n\n  if (typeof stack === 'string') {\n    stack = stack.split('\\n');\n    if (stack[0] === `${error.name}: ${error.message}`) stack.shift();\n  }\n\n  return {\n    name: error.name,\n    code: error.code,\n    message: error.message,\n    fileName: error.fileName,\n    lineNumber: error.lineNumber,\n    columnNumber: error.columnNumber,\n    stack\n  };\n}\n\nfunction reportError(error) {\n  var now = new Date();\n  if (error instanceof Error) report({\n    error: getErrorData(error)\n  }, now);else report({\n    error\n  }, now);\n}\n\nfunction report(data, now) {\n  if (now === undefined) now = new Date();\n  if (data === undefined || data === null) return;\n  if (typeof data !== 'object') data = {\n    report: data\n  };\n  data.createdAt = now;\n  data.page = location.href;\n\n  try {\n    sendReport(JSON.stringify(data));\n  } catch (e) {\n    var error = 'Stringify report failed: ' + e;\n    error = error.replace(/\"/g, '\\\\\"');\n    sendReport('{\"error\":\"' + error + '\"}');\n  }\n}\n\nfunction sendReport(data) {\n  if (window.sessionstorage) window.sessionstorage.setItem('reportData', data);\n  $.ajax({\n    method: 'POST',\n    url: (config_client_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"].apiPrefix || '') + '/report',\n    contentType: 'application/json',\n    data: data\n  }).done(function () {\n    if (window.sessionStorage) window.sessionStorage.removeItem('reportData');\n  }).fail(function () {\n    setTimeout(function () {\n      sendReport(data);\n    }, 5000);\n  });\n}\n\nwindow.report = report;\nwindow.reportError = reportError;//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///./src/errors.js\n")}},__webpack_module_cache__={};function __webpack_require__(e){var n=__webpack_module_cache__[e];if(void 0!==n)return n.exports;var c=__webpack_module_cache__[e]={exports:{}};return __webpack_modules__[e](c,c.exports,__webpack_require__),c.exports}__webpack_require__.d=(e,n)=>{for(var c in n)__webpack_require__.o(n,c)&&!__webpack_require__.o(e,c)&&Object.defineProperty(e,c,{enumerable:!0,get:n[c]})},__webpack_require__.g=function(){if("object"==typeof globalThis)return globalThis;try{return this||new Function("return this")()}catch(e){if("object"==typeof window)return window}}(),__webpack_require__.o=(e,n)=>Object.prototype.hasOwnProperty.call(e,n),__webpack_require__.r=e=>{"undefined"!=typeof Symbol&&Symbol.toStringTag&&Object.defineProperty(e,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(e,"__esModule",{value:!0})};var __webpack_exports__=__webpack_require__("./src/errors.js")})();